  ...
  return (
    <LegalLayout title="서비스 이용약관" tag="Terms of Service">
      ...
      <Sec num="3" title="서비스 내용">
        <Ul items={['학원 출결 관리 (출석·지각·결석·조퇴 기록)','수납 관리 (수업료·교재비 청구 및 납부 현황 관리)','공지사항 및 메시지 발송','숙제 관리 및 학부모 공유','학부모 모바일 앱 연동 (Android)','카카오 알림톡·문자 발송','기타 회사가 추가 개발·제공하는 서비스']} />
      </Sec>
      ...
      <Sec num="5" title="요금제 및 결제">
        ...
        <P>충전된 포인트의 이용 기간 및 환불 가능 기간은 결제 시점으로부터 1년 이내로 제한됩니다. 충전된 포인트는 이용자 간 양도가 불가합니다.</P>
      </Sec>
      ...
      <Sec num="6" title="환불 정책">
        ...
        <LTable
          headers={['포인트 항목','정책']}
          rows={[
            ['충전·구매 포인트 (이용·환불·양도)','이용 및 환불 가능 기간은 결제 시점으로부터 1년 이내이며, 이용자·회원 간 양도는 불가합니다.\n포인트 구매 이후 환불은 결제가 되었던 수단으로 진행됩니다.'],
            ['사용된 포인트','회사 정책에 따라 환불 불가'],
            ['미사용 잔여 포인트','고객 요청 및 결제 증빙 확인 후 회사 정책에 따라 환불 가능'],
            ['무상 지급 포인트(이벤트 등)','회사 정책에 따라 환불 불가'],
          ]}
        />
  ...
  return (
    <LegalLayout title="환불 정책" tag="Refund Policy">
      ...
      <div style={{ background: '#fff', borderRadius: 16, padding: 32, marginBottom: 16, border: '1px solid var(--bd)' }}>
        ...
        <div style={{ fontSize: 18, fontWeight: 800, color: 'var(--navy)', marginTop: 28, marginBottom: 20, paddingBottom: 12, borderBottom: '2px solid var(--ok2)' }}>💳 포인트 환불 정책</div>
        <LTable
          headers={['포인트 항목','정책']}
          rows={[
            ['충전·구매 포인트 (이용·환불·양도)','이용 및 환불 가능 기간은 결제 시점으로부터 1년 이내이며, 이용자·회원 간 양도는 불가합니다.\n포인트 구매 이후 환불은 결제가 되었던 수단으로 진행됩니다.'],
