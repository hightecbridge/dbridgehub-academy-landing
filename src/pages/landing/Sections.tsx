...
const FEATURES = [
  ...
  { icon: '📱', title: '학부모 앱 연동', desc: '학부모가 스마트폰으로 자녀의 출석·숙제·수납·공지를 실시간 확인. 상담 신청도 앱에서.', items: ['Android 전용 앱', '실시간 푸시 알림', '온라인 상담 신청'] },
...
/* ══ FAQ ══════════════════════════════════════════ */
const FAQS = [
  ['무료 체험에 카드 등록이 필요한가요?', '아니요, 30일 무료 체험은 신용카드 없이 시작 가능합니다. 체험 종료 후 계속 이용을 원하실 때 토스페이먼츠 정기 빌링에 카드 등록 후 결제를 진행하시면 됩니다.'],
  ['기존 데이터를 가져올 수 있나요?', '엑셀 파일로 학생·학부모 정보를 일괄 업로드할 수 있습니다. 데이터 이전이 어려우시면 고객센터로 문의해 주시면 안내해드립니다.'],
  ['학부모 앱은 별도 비용이 있나요?', '학부모 앱은 모든 요금제에 무료로 포함됩니다. 학부모님들은 Google Play에서 무료로 다운로드하시면 됩니다.'],
